...
const PRODUCTS = [
  { id: 'golden-arrow', title: 'The Golden Arrow', subtitle: 'The Coin They Tried to Kill', price: '$12,500.00', image: 'https://beaverworksmint.ca/wp-content/uploads/2025/08/GoldenArrow22.jpg' },
  { id: 'rcaf-silver-maple', title: 'The RCAF Silver Maple', subtitle: 'Born from Grit', price: '$145.00', image: 'https://beaverworksmint.ca/wp-content/uploads/2025/08/SilverMaple1.jpg' },
  { id: 'supermarine-spitfire', title: 'The Supermarine Spitfire', subtitle: 'Legacy Series', price: '$155.00', image: 'https://beaverworksmint.ca/wp-content/uploads/2025/08/Spitfire.jpg' },
];
...
export const ProductGrid: React.FC<ProductGridProps> = ({ onNavigate }) => {
  const handleClick = (productId: string) => {
    if (onNavigate) {
      onNavigate(productId, 'product');
    }
  };
